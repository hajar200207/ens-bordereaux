...
<div class="max-w-4xl mx-auto">
    <div class="flex items-center justify-between mb-6">
        ...
        <a href="<?php echo e(route('admin.users.index')); ?>" class="ens-btn-secondary">Retour</a>
    </div>

    <div class="ens-card p-6">
        <form method="POST" action="<?php echo e(route('admin.users.store')); ?>" class="grid grid-cols-1 md:grid-cols-2 gap-5">
            <?php echo csrf_field(); ?>

            <div>
                <label class="ens-label">Prénom</label>
                <input type="text" name="first_name" value="<?php echo e(old('first_name')); ?>" class="ens-input" required>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div>
                ...
                <input type="text" name="last_name" value="<?php echo e(old('last_name')); ?>" class="ens-input" required>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div>
                ...
                <input type="email" name="email" value="<?php echo e(old('email')); ?>" class="ens-input" required>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div>
                ...
                <input type="text" name="username" value="<?php echo e(old('username')); ?>" class="ens-input">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div class="md:col-span-2 flex justify-end gap-3">
                <a href="<?php echo e(route('admin.users.index')); ?>" class="ens-btn-secondary">Annuler</a>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Lenovo\Desktop\ens-bordereaux\ens-bordereaux\resources\views/admin/users/create.blade.php ENDPATH**/ ?>