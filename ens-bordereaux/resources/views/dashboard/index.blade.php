...
@section('content')
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-5 mb-8">
        <x-card title="Documents en attente" value="12" subtitle="À traiter" color="yellow" icon="⏳" />
        <x-card title="En cours" value="18" subtitle="Services actifs" color="blue" icon="📌" />
        <x-card title="Validés" value="34" subtitle="Décisions favorables" color="green" icon="✔" />
        <x-card title="Refusés" value="5" subtitle="À corriger" color="red" icon="✖" />
    </div>
