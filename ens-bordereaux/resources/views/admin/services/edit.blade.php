...
@section('content')
    <div class="max-w-3xl mx-auto">
        <div class="mb-8">
            <h1 class="text-3xl font-bold text-slate-800">Modifier le service</h1>
            <p class="text-slate-500 mt-1">Mise à jour des informations du service.</p>
        </div>
            ...
            <form method="POST" action="{{ route('admin.services.update', $service) }}" class="space-y-5">
                ...
                <div>
                    ...
                    <textarea name="description" rows="4"
                              class="w-full rounded-xl border-slate-300 focus:border-[#1F4E79] focus:ring-[#1F4E79]">{{ old('description', $service->description) }}</textarea>
                </div>
