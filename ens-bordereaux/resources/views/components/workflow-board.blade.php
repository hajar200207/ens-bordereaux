...
<div class="grid grid-cols-1 xl:grid-cols-12 gap-6 mb-6">
    <div class="xl:col-span-4 ens-card p-6 cursor-glow-card">
    ...
    <div class="xl:col-span-4 ens-card p-6 cursor-glow-card">
        ...
        <div class="space-y-4">
            <div class="rounded-2xl border border-slate-200 p-4 bg-slate-50 hover:shadow-sm transition">
...
@php
    $workflowSteps = [
        ...
        [
            ...
            'status' => 'done',
            'actor' => 'Directeur',
            'comment' => 'Décision prise pour traitement par le service Communication.',
        ],
        [
            'icon' => '📌',
            ...
            'status' => 'done',
            'actor' => 'Directeur',
            'comment' => 'Instruction envoyée au service concerné.',
        ],
        [
            'icon' => '⚠️',
            ...
            'status' => 'warning',
            'actor' => 'Directeur',
            'comment' => 'Correction demandée sur la hiérarchie visuelle et le logo.',
        ],
        [
            'icon' => '🎨',
            ...
            'status' => 'current',
            'actor' => 'Communication',
            'comment' => 'Version corrigée disponible pour validation.',
        ],
        [
            'icon' => '✅',
            ...
            'comment' => 'Étape non encore atteinte.',
        ],
    ];
@endphp

<x-workflow-timeline-premium :steps="$workflowSteps" />
